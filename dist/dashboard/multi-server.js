...
import { validateAndCheckPort } from './utils.js';
...
export class MultiProjectDashboardServer {
    ...
    registerApiRoutes() {
        ...
        this.app.get('/api/projects/:projectId', async (request, reply) => {
        ...
        this.app.get('/api/projects/:projectId/specs/:specId', async (request, reply) => {
        ...
        this.app.get('/api/projects/:projectId/constitution', async (request, reply) => {
            const { projectId } = request.params;
            try {
                const project = self.projectRegistry.getProjectContext(projectId);
                if (!project) {
        ...
        this.app.get('/api/projects/:projectId/templates', async (request, reply) => {
            const { projectId } = request.params;
            try {
                const project = self.projectRegistry.getProjectContext(projectId);
                if (!project) {
        ...
        this.app.get('/api/projects/:projectId/scripts', async (request, reply) => {
            const { projectId } = request.params;
            try {
                const project = self.projectRegistry.getProjectContext(projectId);
                if (!project) {
        ...
        this.app.get('/api/projects/:projectId/agents', async (request, reply) => {
            const { projectId } = request.params;
            try {
                const project = self.projectRegistry.getProjectContext(projectId);
                if (!project) {
        ...
        this.app.get('/api/projects/:projectId/specs/list', async (request, reply) => {
            const { projectId } = request.params;
            try {
                const project = self.projectRegistry.getProjectContext(projectId);
                if (!project) {
        ...
        this.app.get('/api/projects/:projectId/specs/:featureNumber/tasks', async (request, reply) => {
        ...
        this.app.put('/api/projects/:projectId/specs/:featureNumber/tasks', async (request, reply) => {
            const { projectId, featureNumber } = request.params;
        ...
        this.app.post('/api/projects/:projectId/specs/:featureNumber/tasks/assign', async (request, reply) => {
            const { projectId, featureNumber } = request.params;
            const { taskId, agentName, command } = request.body;
            try {
                const project = self.projectRegistry.getProjectContext(projectId);
                if (!project) {
                    return reply.code(404).send({ error: 'Project not found' });
     ...
     */
    broadcastProjectDiscovered(projectId, projectName, projectType, projectPath) {
        this.broadcastToAll({
     ...
     */
    broadcastAgentDetected(projectId, agentName, commandCount) {
        this.broadcastToProject(projectId, {
            type: 'agent.detected',
            data: {
                projectId,
     ...
     */
    broadcastProjectRemoved(projectId, projectName) {
        this.broadcastToAll({
     ...
     */
    broadcastProjectUpdated(projectId, changedPaths) {
        this.broadcastToAll({
