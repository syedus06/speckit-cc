...
- [ ] **Specs Before Solutions** — Requirements, design research, and success criteria are complete; no code will start before these artifacts are approved.
- [ ] **Independent Story Slices** — Each user story can be scoped, implemented, and tested without touching another story's files (or the Complexity Tracking table documents the exception).
